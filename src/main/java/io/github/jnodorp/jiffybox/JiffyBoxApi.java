...
import io.github.jnodorp.jiffybox.modules.*;

import java.net.URI;

/**
 * This is the base class of the JiffyBox API. Usually it should be created only once. You have to specify the API token
 * to use. Furthermore, it is possible to add a host, which is useful for testing purposes.
 *
 * @see ModuleBackups
 * @see ModuleContactGroups
 * @see ModuleDistributions
 * @see ModuleDoc
 * @see ModuleIps
 * @see ModuleJiffyBoxes
 * @see ModuleMonitoring
 * @see ModulePlans
 */
